...
def test_csv_data(processed_data, nanoscale_mode=False, DEBUG=False):
    ...
    for processed_item in processed_data:
        ...
        if not csv_row.empty:
            ...
            if (
                ...
                if nanoscale_mode:
                    # load csv file 
                    csv_file1 = os.path.join(parent_directory, "pixelWidth.csv")
                ...
                if store_failed_images:
                    ...
                    folder_with_images = os.path.join(parent_directory, "Data_Storage", "others", "WholeDataset")
                    folder_for_failed_images = os.path.join(parent_directory, "FailedImages")
